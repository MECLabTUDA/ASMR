...
#python3 main.py --exp_path=mirko/camelyon17_ana_mirko_fedavgm_seed1.yml --logfile=final/experiment1_seeds/mirko/camelyon_ana_mirko_avgm_le1_seed1_norm.log --gpu=0,1
#python3 main.py --exp_path=mirko/camelyon17_ana_mirko_fedavgm_seed2.yml --logfile=final/experiment1_seeds/mirko/camelyon_ana_mirko_avgm_le1_seed2_norm.log --gpu=0,1
#python3 main.py --exp_path=mirko/camelyon17_ana_mirko_fedavgm_seed3.yml --logfile=final/experiment1_seeds/mirko/camelyon_ana_mirko_avgm_le1_seed3_norm.log --gpu=0,1
python3 main.py --exp_path=mirko/camelyon17_ana_mirko_fedavgm_seed4.yml --logfile=final/experiment1_seeds/mirko/more_more.log --gpu=0,1
#python3 main.py --exp_path=mirko/camelyon17_ana_mirko_fedavgm_seed5.yml --logfile=final/experiment1_seeds/mirko/camelyon_ana_mirko_avgm_le1_seed5_norm.log --gpu=0,1
#python3 main.py --exp_path=mirko/camelyon17_ana_mirko_fedavgm_seed6.yml --logfile=final/experiment1_seeds/mirko/camelyon_ana_mirko_avgm_le1_seed6_norm.log --gpu=0,1
#python3 main.py --exp_path=mirko/camelyon17_ana_mirko_fedavgm_seed7.yml --logfile=final/experiment1_seeds/mirko/camelyon_ana_mirko_avgm_le1_seed7_norm.log --gpu=0,1
#python3 main.py --exp_path=mirko/camelyon17_ana_mirko_fedavgm_seed8.yml --logfile=final/experiment1_seeds/mirko/camelyon_ana_mirko_avgm_le1_seed8_norm.log --gpu=0,1
#python3 main.py --exp_path=mirko/camelyon17_ana_mirko_fedavgm_seed9.yml --logfile=final/experiment1_seeds/mirko/camelyon_ana_mirko_avgm_le1_seed9_norm.log --gpu=0,1
#python3 main.py --exp_path=mirko/camelyon17_ana_mirko_fedavgm_seed10.yml --logfile=final/experiment1_seeds/mirko/camelyon_ana_mirko_avgm_le1_seed10_norm.log --gpu=0,1
